            ...
            try {
                ...
                switch (pilihan) {
                    case 1 -> {
                        ...
                        System.out.println(menu[0] + " x" + porsiAyam + " = Rp" + subtotal);
                    }
                    ...
                    case 2 -> {
                        ...
                        System.out.println(menu[1] + " x" + porsiIkan + " = Rp" + subtotal);
                    }
                    ...
                    case 3 -> {
                        ...
                        System.out.println(menu[2] + " x" + porsiDaging + " = Rp" + subtotal);
                    }
                    ...
                    case 4 -> {
                        ...
                        System.out.println(menu[3] + " x" + porsiSayur + " = Rp" + subtotal);
                    }
